  ...
  private createSampleJobRoles(): JobRole[] {
    return [
      ...
      },
      {
        ...
        keyResponsibilities: [
          "Define technical strategy and architecture for large-scale projects",
          "Lead cross-functional teams and technical initiatives",
      ...
      },
      {
        ...
        keyResponsibilities: [
          ...
          "Implement data science solutions in production environments",
        ],
      },
      {
        id: 5,
        ...
        keyResponsibilities: [
          "Lead complex data science projects from conception to delivery",
          "Develop advanced machine learning models and algorithms",
          "Mentor junior data scientists and analysts",
          "Present findings and recommendations to senior stakeholders",
          "Drive best practices in data science methodology",
        ],
      },
      {
        id: 6,
      ...
      },
      {
        ...
        keyResponsibilities: [
          ...
          "Lead DevOps transformation initiatives for client projects",
          "Design disaster recovery and business continuity strategies",
          "Mentor junior DevOps engineers and platform specialists",
          "Drive automation and optimization across all environments",
        ],
      },
      {
        id: 8,
      ...
      },
      {
        ...
        keyResponsibilities: [
          "Lead business analysis for large-scale transformation projects",
          ...
          "Mentor junior business analysts and team members",
        ],
      },
      {
        id: 10,
